...
const messages: Record<string, string> = {
  ...
  AUTHENTICATION_REQUIRED: "Tu sesión ya no está disponible. Iniciá sesión de nuevo.",
...
export function isAuthCode(error: unknown, code: string): error is AuthApiError {
